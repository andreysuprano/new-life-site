...
export default function TopoLp() {
  return (
    <>
      <Head>
        <link
      ...
      <Container maxW={'full'} bgColor={'#ECF1F6'}>
        <Stack
          as={Box}
          textAlign={'center'}
          ...
          <Heading
            ...
            Facetas e Lentes <br />
            <Text as={'span'} color={'blue.400'} fontSize={{ base: '3xl', sm: '3xl', md: '3xl' }}>
          ...
          <Stack
            ...
            <Button
              ...
              onClick={()=>{
                sendToLink('https://encurtador.com.br/bjknP')
              }}
              >
              Eu quero!
            </Button>          
